			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      ...
			      <ul class="nav navbar-nav navbar-right">
			      	...
			      	<li><span class="badge badge-weight">{{ App\User::weight() }}</span></li>
			      	<li><a class="profile-link" href="/profile"><img class="circle" src="{{ App\User::get_gravatar(Auth::user()->email) }}"></a></li>
