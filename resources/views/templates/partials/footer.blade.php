...
@else
    ...
    UserVoice=window.UserVoice||[];(function(){var uv=document.createElement('script');uv.type='text/javascript';uv.async=true;uv.src='<?php echo getenv('USERVOICE_URL'); ?>';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(uv,s)})();
...
<script type="text/javascript" src="{{ asset('assets/js/laravel.js') }}"></script>
